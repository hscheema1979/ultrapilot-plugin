...
<!--Original: skills/ultra-pipeline/SKILL.md-->
...
Pipelines maintain state in `.ultra/pipeline-state.json`:
...
**Check:** `.ultra/pipeline-state.json` for current stage
...
rm -f .ultra/state/pipeline-state.json
```
